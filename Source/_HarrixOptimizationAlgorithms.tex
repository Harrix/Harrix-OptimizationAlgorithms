...
\input{HML_StandartBinaryGeneticAlgorithm}
\input{HML_StandartRealGeneticAlgorithm}
...
\input{HML_RealGeneticAlgorithmWDPOfNOfGPS}
...
\input{HML_RealGeneticAlgorithmTournamentSelectionWithReturn}
...
\input{HML_BinaryMonteCarloAlgorithm}
